 ...
 * @LastEditTime: 2024-10-19 10:24:53
 * @License: GPL 3.0
-->
...
| [lilygo_s3_apps](https://github.com/Xinyuan-LilyGO/T-Circle-S3/tree/esp-idf-V4.4.8/examples/lilygo_s3_apps) | `[ESP-IDF][esp-idf-V4.4.8]` | 该示例为语音控制示例，由Grovety提供，以下是原始链接: <br /> [Grovety lilygo_s3_apps](https://github.com/Grovety/lilygo_s3_apps)| <p align="center" width="50%"> <img src="image/1.jpg" alt="example" width="100%"> </p> |
